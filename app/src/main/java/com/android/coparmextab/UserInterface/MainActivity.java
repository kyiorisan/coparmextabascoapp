...
public class MainActivity extends Activity implements NavigationDrawerFragment.NavigationDrawerCallbacks,OnFragmentInteractionListener {
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        Fragment botFragment = fragmentManager.findFragmentById(R.id.bottom_fragment);
        switch (position) {
     ...
     * @param v utilizado por el OnClick Listener.
     */
    public void cambioVista(View v) {
        if (((RadioButton) rootview.findViewById(R.id.radio0)).isChecked()) {
            // llamado a query de oferta
            Toast.makeText(rootview.getContext(), "Ofertas", Toast.LENGTH_SHORT).show();// TODO: Borrar este toast de prueba cuando se implemente el comportamiento de este caso de uso.
            getFragmentManager().beginTransaction().replace(R.id.bottom_fragment, OfertaFragment.newInstance(1),"BotFragment").commit();
            mTitle="Ofertas";
        }

        if (((RadioButton) rootview.findViewById(R.id.radio1)).isChecked()) {
            // llamado a query de empresas
            TextView tv = (TextView) findViewById(R.id.textoBusqueda);
            Toast.makeText(rootview.getContext(), "Empresas", Toast.LENGTH_SHORT).show();
        ...
        if (((RadioButton) rootview.findViewById(R.id.radio2)).isChecked()) {
            ...
            Toast.makeText(rootview.getContext(), "Productos", Toast.LENGTH_SHORT).show();// TODO-ME Borrar este toast de prueba cuano se implemente el comportamiento de este caso de uso.
